...
const PATHS = {
  ...
  clock: [["circle", 12, 12, 9], ["path", "M12 7v5.4l3.5 2.1"]],
  lock: [["rect", 4, 10.5, 16, 10.5, 2.4], ["path", "M8 10.5V7.2a4 4 0 0 1 8 0v3.3"]],
  unlock: [["rect", 4, 10.5, 16, 10.5, 2.4], ["path", "M8 10.5V7.2a4 4 0 0 1 7.5-2"]],
  eyeOff: [["path", "M9.9 5.1A9.6 9.6 0 0 1 12 4.9c5 0 9 4.2 9.8 6.6a11 11 0 0 1-2.6 3.8M6.2 6.9A12 12 0 0 0 2.2 11.5C3 13.9 7 18.1 12 18.1a9.9 9.9 0 0 0 4-.9"], ["path", "M9.9 9.9a3 3 0 0 0 4.2 4.2"], ["path", "M2.5 2.5l19 19"]],
  ...
  eye: [["path", "M2.2 12C3.6 7.9 7.5 5 12 5s8.4 2.9 9.8 7c-1.4 4.1-5.3 7-9.8 7s-8.4-2.9-9.8-7z"], ["circle", 12, 12, 3]],
  sun: [["circle", 12, 12, 4], ["path", "M12 2.5v2M12 19.5v2M4.6 4.6l1.4 1.4M18 18l1.4 1.4M2.5 12h2M19.5 12h2M4.6 19.4L6 18M18 6l1.4-1.4"]],
  moon: [["path", "M20.5 14.2A8.5 8.5 0 1 1 9.8 3.5a6.8 6.8 0 0 0 10.7 10.7z"]],
  monitor: [["rect", 2.5, 4, 19, 13, 2.2], ["path", "M8.5 21h7M12 17v4"]],
  shield: [["path", "M12 21.5s8-3.6 8-9.8V5.2L12 2.5 4 5.2v6.5c0 6.2 8 9.8 8 9.8z"], ["path", "M8.8 12l2.3 2.3 4.3-4.6"]],
  key: [["circle", 7.5, 15.5, 4.5], ["path", "M10.7 12.3L20.5 2.5M16.5 6.5l3 3M14 9l2 2"]],
  arrowDown: [["path", "M12 5v14"], ["path", "M18.5 12.5L12 19l-6.5-6.5"]],
  home: [["path", "M3.5 10.5L12 3.5l8.5 7V19a2 2 0 0 1-2 2h-3.5v-6h-6v6H5.5a2 2 0 0 1-2-2z"]],
};
